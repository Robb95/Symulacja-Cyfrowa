...
private:
    ...
    const int kNumberOfStations_=5; // constant describing the number of base stations
    ...
    const int kAmountOfRetransmission=6; // constant describing the number of retransmissions allowed
    Package* tmp;
