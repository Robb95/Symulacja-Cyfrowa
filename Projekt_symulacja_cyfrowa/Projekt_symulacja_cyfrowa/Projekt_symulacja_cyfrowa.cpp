...
int main()
{
    ...
    int condition = (number_of_simulations * 4 * 2) + number_of_simulations;
   // cerr << condition << endl;
    while (condition1)
    {
   ...
   // {
      ...
      for (int i = 0; i < wireless_network->GetAmountNumberOfStations(); i++)
      {
        ...
        time_for_generate_package = wireless_network->ExponentialGenerator(0.1, seed, i);
