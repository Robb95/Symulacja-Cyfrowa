...
void GeneratePackage::Execute()
{
	...
	double time_for_generate_package = network_->ExponentialGenerator(0.3, seed, id_base_station_);
	TimeEvent* genarte_new_package = new GeneratePackage(network_, time_+ time_for_generate_package, id_base_station_, event_);
